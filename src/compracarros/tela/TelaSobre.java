...
public class TelaSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sistema para controle de gastos de veículos comprados para revenda.");

        jLabel2.setText("Desenvolvido por Washington Klisnmanny");

        jLabel3.setText("Licença GPL");

        jLabel4.setText("Dezembro 2022 versão 1.0");

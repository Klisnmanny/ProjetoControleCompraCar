...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public void logar(){
        ...
        try {
            ...
            String capturar = new String(txtSenha.getPassword());
            pst.setString(2,capturar);
            ...
            if (rs.next()){
                ...
                this.dispose();
                TelaPrincipal.LbNome.setText(rs.getString(2));
                ligar.close();
            }else{
    ...
    private void initComponents() {
        ...
        setTitle("GASTOS DE CARROS - LOGIN");
        setResizable(false);
        ...
        setSize(new java.awt.Dimension(398, 207));
